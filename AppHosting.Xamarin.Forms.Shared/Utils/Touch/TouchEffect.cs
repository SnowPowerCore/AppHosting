...
using AppHosting.Xamarin.Forms.Shared.EventArgs;
...
namespace AppHosting.Xamarin.Forms.Shared.Utils.Touch
{
    public class TouchEffect : RoutingEffect
    {
        ...
        private static void TryGenerateEffect(BindableObject? bindable, object oldValue, object newValue)
        {
            ...
            if (view is default(VisualElement) || view.Effects.OfType<TouchEffect>().Any())
                return;
        ...
        public bool CanExecute => IsAvailable
        ...
        public static TouchEffect? PickFrom(BindableObject? bindable)
        {
            var effects = (bindable as VisualElement)?.Effects?.OfType<TouchEffect>();
