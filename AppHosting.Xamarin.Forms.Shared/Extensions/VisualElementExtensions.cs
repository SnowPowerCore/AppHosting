...
namespace AppHosting.Xamarin.Forms.Shared.Extensions
{
	...
	public static partial class VisualElementExtensions
    {
        public static Task<bool> ColorTo(this VisualElement element, Color color, uint length = 250u, Easing? easing = null)
        {
            ...
            element.BackgroundColor ??= (Color)Application.Current.Resources[nameof(element.BackgroundColor)];
            new Animation
            {
            ...
            }.Commit(element, nameof(ColorTo), 16, length, easing ?? Easing.Default, (d, b) => animationCompletionSource.SetResult(true));
